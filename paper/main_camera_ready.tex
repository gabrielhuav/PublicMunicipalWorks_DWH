...
The result does not flatter the design uniformly. The warehouse is far quicker than claimed: the
...
\texttt{v1.6.0-icokg2026}), gives the landing page 85 for performance and the
...
ranking. Both improve with prevalence (the rule from .217 to .555 precision
between 5 and 20\%).
