...
Figure~\ref{fig:mapa_interfaz} shows the main interface, with georeferenced markers color-coded by the state of the work and the technical-card popup that displays physical and financial progress indicators when a node is selected. \rev{It is part of the released artefact and is reachable from the navigation bar of every page.}
